...
let dressUp = 10
let eatBreakfast = 10
let snoozeAlarmAndWakeUpLate = 14
let shower = 10
let fixLunch = 5
// Add more here...
...
let timeForRoutine = brushTeeth + dressUp + eatBreakfast + snoozeAlarmAndWakeUpLate + fixLunch
...
let thingsIHaveToDo = dressUp + brushTeeth + eatBreakfast
let thingsILikeToDo = shower + fixLunch + snoozeAlarmAndWakeUpLate
