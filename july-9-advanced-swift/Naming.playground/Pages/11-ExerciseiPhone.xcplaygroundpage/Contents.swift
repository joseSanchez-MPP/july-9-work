...
*/
let videoCapacity = ((1024 * 8) - (1024 * 3)) / 150 // this gets the amount of MBs left when subtracting used from total, and then divides by 150 per minute

print("\(videoCapacity) will fill up the phone.")
