...
let name = "Jason";
let lastSlept = "last Thursday";
let feeling = "groggy";
let summerActions = ["sleep", "read"];
let animal = "puppy";
let story = "\(name) was returning from his last day of school, which was calming. He hadn't slept since \(lastSlept) and had been feeling \(feeling) due to finals. He was so glad he'd be able to \(summerActions[0]) and \(summerActions[1]) peacefully. Suddenly a \(animal) crashed into him. He grabbed it, looked for its owner, and saw a lost dog poster. Looks like he'll have to do some work to find the owner and return the \(animal)!";
